...
export const ConstructorIngredients = ({ingredient, index, removeIngredient, moveIngredients}) => {
    ...
    const [{handlerId}, drop] = useDrop({
        ...
        const [{ isDragging }, drag] = useDrag({
          ...
          drag(drop(ref))
    return (
    <li className={constructorIngredients.constructorIngredients} ref={ref} data-handler-id={handlerId} style={{ opacity }}>
