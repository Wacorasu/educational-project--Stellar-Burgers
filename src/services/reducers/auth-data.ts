...
import type { TAuthDataState} from "../types/auth";
import type { TAuthActions } from "../actions/auth-data";

const initialState : TAuthDataState = {
  isLoading: false,
  hasError: false,
  isAuth: false,
  userData: null,
  ...
  errors: {
    errorUser: { hasError: false, message: "" },
    errorAuth: { hasError: false, message: "" },
    errorUpdateUser: { hasError: false, message: "" },
    errorLogout: { hasError: false, message: "" },
    errorRegister: { hasError: false, message: "" },
    errorResetPassword: { hasError: false, message: "" },
    errorSendPassword: { hasError: false, message: "" },
    errorRefreshToken: { hasError: false, message: "" },
  },
};

export const authDataReducer = (state = initialState, action: TAuthActions):TAuthDataState  => {
  switch (action.type) {
    case USER_REQUEST: {
      return {
        ...state,
    ...
    case USER_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorUser: { hasError: true, message: action.payload.message },
        },
      };
    }
    ...
    case USER_UPDATE_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorUpdateUser: { hasError: true, message: action.payload.message },
        },
      };
    }
    ...
    case REGISTER_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorRegister: { hasError: true, message: action.payload.message },
        },
      };
    }
    case AUTH_REQUEST: {
    ...
    case AUTH_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorAuth: { hasError: true, message: action.payload.message },
        },
      };
    }
    case LOGOUT_REQUEST: {
    ...
    case LOGOUT_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorLogout: { hasError: true, message: action.payload.message },
        },
      };
    }
    ...
    case RESET_PASSWORD_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorResetPassword: { hasError: true, message: action.payload.message },
        },
      };
    }
    ...
    case SEND_PASSWORD_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorSendPassword: { hasError: true, message: action.payload.message },
        },
      };
    }
    ...
    case REFRESH_TOKEN_REQUEST_FAILED: {
      return {
        ...
        errors: {
          ...state.errors,
          errorRefreshToken: { hasError: true, message: action.payload.message },
        },
      };
    }
